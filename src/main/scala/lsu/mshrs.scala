  ...
  with HasL1HellaCacheParameters
{
  ...
  //yh-val rpq = Module(new BranchKillableQueue(new BoomDCacheReqInternal, cfg.nRPQ, u => u.uses_ldq, false))
  val rpq = Module(new BranchKillableQueue(new BoomDCacheReqInternal, cfg.nRPQ, u => (u.uses_ldq || u.is_edgld), false)) //yh+
  ...
  with HasL1HellaCacheParameters
{
  ...
  //yh-val respq = Module(new BranchKillableQueue(new BoomDCacheResp, 4, u => u.uses_ldq, flow = false))
  val respq = Module(new BranchKillableQueue(new BoomDCacheResp, 4, u => (u.uses_ldq || u.is_edgld), flow = false)) //yh+
